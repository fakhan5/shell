...
cp ./data/raw/*server*.log to ./data/processed/server_logs
# 6. Repeat the above step for user logs and event logs
cp ./data/raw/*user*.log to ./data/processed/user_logs
cp ./data/raw/*event*.log to ./data/processed/event_logs
